...
class OdooAwait {
  ...
  connect() {
    ...
    return new Promise((resolve, reject) => {
      self.client.methodCall('authenticate', params, function (err, uid) {
        if (err) {
          reject(err);
          return;
        }
  ...
  execute_kw(model, method, params) {
    ...
    return new Promise((resolve, reject) => {
      self.client.methodCall('execute_kw', params, function (err, resp) {
        if (err) {
          reject(err);
          return;
        }
  ...
  async getCookie() {
    return self.client.getCookie('session');
  }
}
